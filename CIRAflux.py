...
xTawCIRA,TawCIRA = readData("TawCIRA.csv",(1e-2,1))
...
#    mug = CEA.interpol(aRatio,AreaCEA,CEAval_curr,muCEA)    
    ...
    Taw = interpol(xTawCIRA,TawCIRA,xVals[-i]) 
    ...
    while (abs(TwNew-Tw)>0.1) and (abs(TwChannel-TwChannelNew))>0.1:
        ...
        #hg = th.bartz(T0,Tw,p0,Mg,rt*2,aRatio,mug,cpg,Prg,gg,cstar)e
        hg = interpol(xhgCIRA,hgCIRA,xVals[-i]) 
